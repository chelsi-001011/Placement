...
public class Student_Check_company_adapter extends ArrayAdapter<Job_Student> {
...
//    }
    ...
    public Student_Check_company_adapter(@NonNull Context context, @NonNull List<Job_Student> objects) {
        super(context, 0, objects);
    }
